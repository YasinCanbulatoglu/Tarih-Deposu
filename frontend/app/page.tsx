...
export default function Home() {
  ...
  const historicalEras = [
    ...
    { title: "Yakın Çağ", description: "Fransız İhtilali'nden günümüze; endüstri, teknoloji ve uzay yarışı.", tag: "1789 - Günümüz" }
  ];
  ...
  const recentStories = [
    ...
    { title: "Samurayların Sonu: Meiji Restorasyonu", category: "Uzak Doğu", excerpt: "Japonya'nın feodal düzenden modern bir dünya gücüne dönüşümü ve samuray kültürünün hazin sonu.", date: "05 Aralık 2024", readTime: "10 dk", imageUrl: "https://images.unsplash.com/photo-1528164344705-4754268799af?q=80&w=800&auto=format&fit=crop" },
    ...
    <div className="min-h-screen bg-white dark:bg-[#0f172a] text-black dark:text-white transition-colors duration-500 font-sans">
      ...
      <nav className="flex items-center justify-between px-16 py-4 border-b border-gray-200 dark:border-[#334EAC]/30 bg-white dark:bg-[#1e293b] sticky top-0 z-50 transition-all duration-500">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded bg-[#334EAC] text-white font-bold text-xs shadow-lg shadow-[#334EAC]/20 font-bold">TK</div>
          <span className="text-xl font-bold tracking-tight">Tarih Deposu</span>
        </div>
        ...
        <div className="flex items-center gap-6 text-sm font-medium">
          <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-[#334EAC] transition-colors font-bold">Ana Sayfa</a>
          <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-[#334EAC] transition-colors font-bold">Hakkında</a>
          <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-[#334EAC] transition-colors font-bold">Depo</a>
      ...
      <main className="max-w-7xl mx-auto px-8 py-8 pb-16 font-sans">
        ...
        {/* 1. Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-white dark:from-[#1e293b] dark:to-[#0f172a] p-10 md:p-14 rounded-xl border border-gray-100 dark:border-white/5 shadow-xl">
            ...
            <div className="relative mt-8">
              ...
              <blockquote className="pl-8 py-1">
                ...
                <div className="mt-8 flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <button className="px-8 py-3 rounded-xl bg-[#334EAC] text-white font-bold hover:bg-[#283d87] transition-all shadow-lg shadow-[#334EAC]/20 active:scale-95 text-sm text-nowrap hover:-translate-y-1">Arşivi Keşfet</button>
                </div>
              </blockquote>
            </div>
          </div>
        ...
        <div className="mt-10 px-6 py-8 bg-[#334EAC]/5 dark:bg-[#334EAC]/10 border border-[#334EAC]/10 rounded-xl relative shadow-sm overflow-hidden text-black dark:text-white">
          <div className="mb-4 px-4">
            <h2 className="text-2xl font-black tracking-tight">Popüler Olaylar</h2>
          ...
          <div className="relative overflow-visible py-10"> 
            <div className="flex animate-marquee overflow-visible">
              {[...popularEvents, ...popularEvents].map((event, index) => (
                <div key={index} className="mx-4 min-w-[320px] p-7 rounded-xl bg-white dark:bg-[#0f172a] border border-gray-100 dark:border-white/5 shadow-md hover:shadow-2xl hover:-translate-y-4 hover:border-[#334EAC]/40 transition-all duration-300 cursor-pointer group relative z-10 flex flex-col justify-between h-52">
                  <div>
        ...
        <div className="mt-12 mb-6 px-4">
          <h2 className="text-2xl font-black tracking-tight">Tarihsel Dönemler</h2>
          <div className="h-1.5 w-24 bg-gradient-to-r from-[#334EAC] to-transparent rounded-full mt-2"></div>
        </div>
          ...
          {historicalEras.map((era, index) => (
            <div key={index} className="p-6 rounded-xl bg-gray-50 dark:bg-[#1e293b]/50 border border-transparent dark:border-white/5 shadow-sm flex flex-col justify-between cursor-pointer transition-all duration-300 hover:-translate-y-3 hover:shadow-2xl hover:border-[#334EAC]/40 group active:scale-95">
              <div>
                ...
                <h3 className="text-lg font-black mt-4 mb-2 tracking-tight group-hover:text-[#334EAC] transition-colors font-bold">{era.title}</h3>
        ...
        <div className="mt-16 mb-8 px-4 flex items-center justify-between relative">
          <div>
            <h2 className="text-2xl font-black tracking-tight">Son Eklenen Olaylar</h2>
            <div className="h-1.5 w-24 bg-gradient-to-r from-[#334EAC] to-transparent rounded-full mt-2"></div>
          </div>
          <div className="relative">
            ...
            {isSortOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-[#1e293b] border border-gray-100 dark:border-white/5 rounded-xl shadow-2xl z-[100] overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-2 text-black dark:text-white">
          {recentStories.map((story, index) => (
            <div key={index} className="group cursor-pointer bg-white dark:bg-[#1e293b]/30 rounded-xl overflow-hidden border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col">
              <div className="relative h-48 w-full overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-4 font-bold">
                  <span className="text-white text-xs">Devamını Oku</span>
                </div>
                <span className="absolute top-4 left-4 px-3 py-1 rounded-lg bg-white/90 dark:bg-[#0f172a]/90 backdrop-blur-md text-[#334EAC] text-[10px] font-black uppercase tracking-wider shadow-sm">
                  {story.category}
                </span>
              </div>
              <div className="p-6 flex-1 flex flex-col">
                <div className="text-gray-400 text-[10px] font-bold mb-2 uppercase tracking-tight">{story.date}</div>
                <h3 className="text-lg font-black mb-3 group-hover:text-[#334EAC] transition-colors leading-tight font-bold">{story.title}</h3>
                <p className="text-[13px] text-gray-500 dark:text-gray-400 line-clamp-2 leading-relaxed mb-6">{story.excerpt}</p>
                <div className="mt-auto pt-4 border-t border-gray-50 dark:border-white/5 flex items-center justify-between text-[11px]">
                  <span className="text-gray-400 font-medium italic">{story.readTime} okuma</span>
      ...
      <footer className="mt-20 border-t border-gray-200 dark:border-[#334EAC]/20 bg-gray-50 dark:bg-[#1e293b] pt-16 pb-8 transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-16 grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold text-gray-600 dark:text-gray-400">
              <li><a href="#" className="hover:text-[#334EAC] transition-colors">Arşiv</a></li>
              <li><a href="#" className="hover:text-[#334EAC] transition-colors">Dönemler</a></li>
              <li><a href="#" className="hover:text-[#334EAC] transition-colors">Popüler Olaylar</a></li>
              <li><a href="#" className="hover:text-[#334EAC] transition-colors">Kategoriler</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold text-gray-600 dark:text-gray-400">
              ...
              <li><a href="#" className="hover:text-[#334EAC] transition-colors">Hakkımızda</a></li>
              <li><a href="#" className="hover:text-[#334EAC] transition-colors">İletişim</a></li>
              <li><a href="#" className="hover:text-[#334EAC] transition-colors">SSS</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer">
        ...
        <div className="max-w-7xl mx-auto px-16 mt-16 pt-8 border-t border-gray-200 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-400 font-bold">© 2024 Tarih Deposu. Tüm hakları saklıdır.</p>
